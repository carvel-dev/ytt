...
//	Value: Map{
//   	Value: Items: [
//          MapItem{Key: "one", Value: "cow", Type: StringType{}},
//          MapItem{Key: "two", Value: 5, Type: StringType{}}
//          MapItem{Key: "not_in_schema", Value: "this...", Type: nil}
//        ],
//  	Type: &[0x01]
// }
//
...
//  }
// DocumentType {
//   Value []interface{} // list of MapSchema or ArraySchema that would satisfy the schema
// }
//
// MapSchema {
//   Allowed []*MapType
...
//  Name: "data.values"
//  Items: [
//    MapItemType{Key: "one", Value: "", Schema: &MapItemSchema{Allowed: []{StringType{}}}},
//    MapItemType{Key: "two", Value: "", Schema: &MapItemSchema{Allowed: []{StringType{}}}}
//  ],
//}
