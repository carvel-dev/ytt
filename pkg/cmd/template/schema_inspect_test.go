...
`
	...
	t.Run("when example and description are provided by @schema/examples", func(t *testing.T) {
		opts := cmdtpl.NewOptions()
		opts.DataValuesFlags.InspectSchema = true
		opts.RegularFilesSourceOpts.OutputType.Types = []string{"openapi-v3"}
...
db_conn:
#@schema/examples ("db_conn array example description", {"hostname": "localhost", "port": 8080, "timeout": 4.2, "any_key": "anything", "null_key": None})
- 
  #@schema/examples ("hostname example description", "localhost")
  hostname: ""
  #@schema/examples ("port example description", 8080)
  port: 0
  #@schema/examples ("timeout example description", 4.2)
  timeout: 1.0
          ...
          items:
            ...
            properties:
              ...
              port:
                type: integer
                default: 0
                x-example-description: port example description
                example: 8080
              timeout:
                type: number
                default: 1
...
`
	...
	t.Run("when only the example is provided by @schema/examples", func(t *testing.T) {
		opts := cmdtpl.NewOptions()
		opts.DataValuesFlags.InspectSchema = true
		opts.RegularFilesSourceOpts.OutputType.Types = []string{"openapi-v3"}
...
`
	...
	t.Run("when multiple examples are provided by @schema/examples", func(t *testing.T) {
		opts := cmdtpl.NewOptions()
		opts.DataValuesFlags.InspectSchema = true
		opts.RegularFilesSourceOpts.OutputType.Types = []string{"openapi-v3"}
		...
		schemaYAML := `#@data/values-schema
---
#@schema/examples ("Exposes the Service on each Node's IP at a static port", "NodePort"), ("Loadbalancer",), ("Maps the Service to the contents of the externalName field", "ExternalName")
service_type: ClusterIP
`
		expected := `openapi: 3.0.0
info:
    ...
    dataValues:
      ...
      properties:
        service_type:
          type: string
          default: ClusterIP
          x-example-description: Exposes the Service on each Node's IP at a static port
          example: NodePort
`
