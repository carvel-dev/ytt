...
non-data-values-doc`)
	...
	if out.Err.Error() != "Overlaying data values (in following order: data.yml, additional data values): Templating file 'data.yml': Expected data values file 'data.yml' to only have data values documents" {
